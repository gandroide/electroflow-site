      ...
      <StyledProductContainer>
        ...
        <StyledProductContent>
          ...
          <StyledProductLink onClick={onOpenModalHandler}>
            {t('translations.products.moreInfo')}
          </StyledProductLink>
        </StyledProductContent>
      </StyledProductContainer>
...
const Products = () => {
  ...
  const productsData = [
    {
      id: 2,
      title: t('translations.products.1.title'),
      carousel: t('translations.products.1.description'),
      modal: [t('translations.products.1.modal.0')],
      image: Quadros,
    },
    {
      id: 3,
      ...
      modal: [t('translations.products.2.modal.1')],
      image: Motoredutores,
    },
    {
      id: 4,
      ...
      modal: [
        t('translations.products.3.modal.0'),
        t('translations.products.3.modal.1'),
      ],
      image: Bombas,
    },
    {
      ...
      modal: [
        t('translations.products.4.modal.0'),
        t('translations.products.4.modal.1'),
      ],
      image: Avac,
    },
    {
      ...
      modal: [
        t('translations.products.5.modal.0'),
        t('translations.products.5.modal.1'),
      ],
      image: Paineis,
    },
  ];
