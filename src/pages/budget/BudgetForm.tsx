  ...
  const formInputs: InputProps[] = [
    {
      ...
      value: '',
      isRequired: true,
      label: t('translations.header.budget.form.name'),
      hasError: false,
      errorMsg: '',
    },
    {
    ...
    },
    {
      ...
      value: '',
      isRequired: true,
      label: t('translations.header.budget.form.address'),
      hasError: false,
      errorMsg: '',
    },
    {
      ...
      value: '',
      isRequired: true,
      label: t('translations.header.budget.form.zipCode'),
      hasError: false,
      errorMsg: '',
    },
    {
      ...
      value: '',
      isRequired: true,
      label: t('translations.header.budget.form.location'),
      hasError: false,
      errorMsg: '',
    },
    // {
    ...
    // },
    {
      ...
      value: '',
      isRequired: true,
      label: t('translations.header.budget.form.LocationInstall'),
      hasError: false,
      errorMsg: '',
    },
    // {
    ...
    // },
    {
      ...
      value: '',
      isRequired: true,
      label: t('translations.header.budget.form.details'),
      hasError: false,
      errorMsg: '',
    },
  ];
